...
public class MainCar {
	...
	public static void main(String[] args) throws Exception {
		...
		params.add("add,macchina,tipoVeicolo=macchina,numeroRuote=4,tipoAlimentazione=benzina,categoria=strada,colore=bianco,marca=fiat,annoProduzione=2006,modello=500,numeroPorte=5,targa=hdgess,cc=125");
